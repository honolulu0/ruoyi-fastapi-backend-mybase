...
class GenUtils:
    ...
    def init_table(cls, gen_table: GenTableModel, oper_name: str) -> None:
        ...
        gen_table.package_name = GenConfig.package_name #py包路径(包)
        gen_table.module_name = GenConfig.package_name #vue模块名
        gen_table.business_name = cls.get_business_name(gen_table.table_name) #文件业务名
